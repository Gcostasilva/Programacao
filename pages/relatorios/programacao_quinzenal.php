    ...
    <form method="get" class="card shadow-sm mb-3 rp05-toolbar">
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3"><label class="form-label">Período</label><select id="rp05Metade" class="form-select">
        ...
        <article class="rp05-document">
            <header class="rp05-header">
                <div class="rp05-header-grid rp05-header-top">
                    <div class="rp05-logo">
                        <div class="rp05-logo-mark">P</div>
                        <div><strong>PERFINASA</strong><small>PERFILADOS DE AÇO</small></div>
                    </div>
                    <div class="rp05-cell rp05-system">
                        <strong>Sistema de Gestão da Qualidade</strong>
                        <span>REGISTRO DE PROCESSO</span>
                    </div>
                    <div class="rp05-header-mid">
                        <div class="rp05-cell rp05-ident">
                            <strong>Identificação: RP 05</strong>
                        </div>
                        <div class="rp05-cell rp05-liberado">
                            <span>Liberado em</span><strong>04/11/2020</strong>
                        </div>
                        <div class="rp05-cell rp05-versao">
                            <span>Versão</span><strong>04</strong>
                        </div>
                    </div>
                </div>
            ...
            <section class="rp05-meta">
                <div class="rp05-line"><strong>Objetivo:</strong> Registrar a programação de produção do produto padrão para um determinado período.</div>
